...
class MultiPart(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["contentDisposition", "entity", "headers", "mediaType", "messageBodyWorkers", "parent", "providers", "bodyParts", "parameterizedHeaders", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["contentDisposition", "entity", "headers", "mediaType", "messageBodyWorkers", "parent", "providers", "bodyParts", "parameterizedHeaders", ], str]):
        return super().get_item_oapg(name)
