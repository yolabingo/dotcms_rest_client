...
class ErrorEntity(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["errorCode", "message", "fieldName", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["errorCode", "message", "fieldName", ], str]):
