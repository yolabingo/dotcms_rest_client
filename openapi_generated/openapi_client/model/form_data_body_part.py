...
class FormDataBodyPart(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            simple = schemas.BoolSchema
        
            @staticmethod
            def formDataContentDisposition() -> typing.Type['FormDataContentDisposition']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["simple"]) -> MetaOapg.properties.simple: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["formDataContentDisposition"]) -> 'FormDataContentDisposition': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["contentDisposition", "entity", "headers", "mediaType", "messageBodyWorkers", "parent", "providers", "simple", "formDataContentDisposition", "name", "value", "parameterizedHeaders", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["simple"]) -> typing.Union[MetaOapg.properties.simple, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["formDataContentDisposition"]) -> typing.Union['FormDataContentDisposition', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["contentDisposition", "entity", "headers", "mediaType", "messageBodyWorkers", "parent", "providers", "simple", "formDataContentDisposition", "name", "value", "parameterizedHeaders", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        simple: typing.Union[MetaOapg.properties.simple, bool, schemas.Unset] = schemas.unset,
        formDataContentDisposition: typing.Union['FormDataContentDisposition', schemas.Unset] = schemas.unset,
