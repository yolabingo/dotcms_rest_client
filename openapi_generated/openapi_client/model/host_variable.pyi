...
class HostVariable(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "hostId", "name", "key", "value", "lastModifierId", "lastModDate", "map", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "hostId", "name", "key", "value", "lastModifierId", "lastModDate", "map", ], str]):
        return super().get_item_oapg(name)
