...
class SidebarView(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["containers", "location", "width", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["containers", "location", "width", ], str]):
