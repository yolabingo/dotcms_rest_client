...
class CategoryView(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["inode", "parent", "description", "keywords", "key", "categoryName", "active", "sortOrder", "categoryVelocityVarName", "modDate", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["inode", "parent", "description", "keywords", "key", "categoryName", "active", "sortOrder", "categoryVelocityVarName", "modDate", ], str]):
