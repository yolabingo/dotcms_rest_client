...
class CopyContentletForm(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["contentId", "pageId", "containerId", "relationType", "personalization", "variantId", "treeOrder", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["contentId", "pageId", "containerId", "relationType", "personalization", "variantId", "treeOrder", ], str]):
