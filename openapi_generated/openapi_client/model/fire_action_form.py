...
class FireActionForm(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["comments", "assign", "publishDate", "publishTime", "expireDate", "expireTime", "neverExpire", "whereToSend", "filterKey", "query", "pathToMove", "timezoneId", "individualPermissions", "iwantTo", "contentlet", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["comments", "assign", "publishDate", "publishTime", "expireDate", "expireTime", "neverExpire", "whereToSend", "filterKey", "query", "pathToMove", "timezoneId", "individualPermissions", "iwantTo", "contentlet", ], str]):
        return super().get_item_oapg(name)
