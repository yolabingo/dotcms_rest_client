...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_app_individual_secret_oapg(
        self,
...
class UpdateAppIndividualSecret(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_app_individual_secret(
        self,
        content_type: typing_extensions.Literal["*/*"] = ...,
        body: typing.Union[SchemaForRequestBody, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_app_individual_secret(
        ...
        return self._update_app_individual_secret_oapg(
            body=body,
