...
# body param
SchemaForRequestBodyApplicationJson = RestConditionGroup


request_body_rest_condition_group = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor0ResponseBodyApplicationJson = RestConditionGroup
...
class BaseApi(api_client.Api):
    ...
    def _update4_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_rest_condition_group.serialize(body, content_type)
