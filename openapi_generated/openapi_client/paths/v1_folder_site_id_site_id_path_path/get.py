...
class BaseApi(api_client.Api):
    @typing.overload
    def _load_folder_and_sub_folders_by_path_oapg(
        self,
...
class LoadFolderAndSubFoldersByPath(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def load_folder_and_sub_folders_by_path(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def load_folder_and_sub_folders_by_path(
        ...
        return self._load_folder_and_sub_folders_by_path_oapg(
