...
# body param
SchemaForRequestBodyApplicationJson = RestRule


request_body_rest_rule = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor0ResponseBodyApplicationJson = RestRule
SchemaFor0ResponseBodyApplicationJavascript = RestRule
...
class BaseApi(api_client.Api):
    ...
    def _update2_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_rest_rule.serialize(body, content_type)
