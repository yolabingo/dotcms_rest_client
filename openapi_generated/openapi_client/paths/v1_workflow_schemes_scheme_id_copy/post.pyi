...
# body param
SchemaForRequestBody = WorkflowCopyForm


request_body_workflow_copy_form = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _copy_scheme_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_workflow_copy_form.serialize(body, content_type)
