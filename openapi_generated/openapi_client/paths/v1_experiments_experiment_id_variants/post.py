...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'experimentId': typing.Union[ExperimentIdSchema, str, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = AddVariantForm


request_body_add_variant_form = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor0ResponseBodyApplicationJson = ResponseEntitySingleExperimentView
SchemaFor0ResponseBodyApplicationJavascript = ResponseEntitySingleExperimentView
...
class BaseApi(api_client.Api):
    ...
    def _add_variant_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_add_variant_form.serialize(body, content_type)
