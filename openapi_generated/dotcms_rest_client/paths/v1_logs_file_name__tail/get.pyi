...
# Query params
LinesBackSchema = schemas.Int32Schema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'linesBack': typing.Union[LinesBackSchema, decimal.Decimal, int, ],
    },
    total=False
)
...
request_query_lines_back = api_client.QueryParameter(
    name="linesBack",
    style=api_client.ParameterStyle.FORM,
    schema=LinesBackSchema,
    explode=True,
)
# Path params
