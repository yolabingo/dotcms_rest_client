...
# body param
SchemaForRequestBody = BrowserQueryForm


request_body_browser_query_form = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _get_folder_content_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_browser_query_form.serialize(body, content_type)
...
class GetFolderContent(BaseApi):
    ...
    def get_folder_content(
        ...
        return self._get_folder_content_oapg(
            body=body,
