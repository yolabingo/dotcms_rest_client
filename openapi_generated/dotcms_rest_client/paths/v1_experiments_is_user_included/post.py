...
# body param
SchemaForRequestBodyApplicationJson = ExcludedExperimentListForm


request_body_excluded_experiment_list_form = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor0ResponseBodyApplicationJson = ResponseEntityExperimentSelectedView
...
class BaseApi(api_client.Api):
    ...
    def _is_user_included_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_excluded_experiment_list_form.serialize(body, content_type)
...
class IsUserIncluded(BaseApi):
    ...
    def is_user_included(
        ...
        return self._is_user_included_oapg(
            body=body,
