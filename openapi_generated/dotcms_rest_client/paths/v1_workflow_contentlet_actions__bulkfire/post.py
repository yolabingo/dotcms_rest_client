...
# body param
SchemaForRequestBody = FireBulkActionsForm


request_body_fire_bulk_actions_form = api_client.RequestBody(
    content={
        '*/*': api_client.MediaType(
            schema=SchemaForRequestBody),
    },
)
SchemaFor0ResponseBodyTextEventStream = EventOutput
...
_response_for_default = api_client.OpenApiResponse(
    ...
    content={
        'text/event-stream': api_client.MediaType(
            schema=SchemaFor0ResponseBodyTextEventStream),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _fire_bulk_actions_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_fire_bulk_actions_form.serialize(body, content_type)
...
class FireBulkActions(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def fire_bulk_actions(
        self,
        content_type: typing_extensions.Literal["*/*"] = ...,
        body: typing.Union[SchemaForRequestBody, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def fire_bulk_actions(
        ...
        return self._fire_bulk_actions_oapg(
            body=body,
