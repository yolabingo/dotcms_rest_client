...
# body param
SchemaForRequestBody = BulkActionForm


request_body_bulk_action_form = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _get_bulk_actions_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_bulk_action_form.serialize(body, content_type)
...
class GetBulkActions(BaseApi):
    ...
    def get_bulk_actions(
        ...
        return self._get_bulk_actions_oapg(
            body=body,
