...
# body param
SchemaForRequestBody = SiteForm


request_body_site_form = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_new_site_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_site_form.serialize(body, content_type)
...
class CreateNewSite(BaseApi):
    ...
    def create_new_site(
        ...
        return self._create_new_site_oapg(
            body=body,
