...
# body param
SchemaForRequestBody = AuthenticationForm


request_body_authentication_form = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _authentication_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_authentication_form.serialize(body, content_type)
...
class Authentication(BaseApi):
    ...
    def authentication(
        ...
        return self._authentication_oapg(
            body=body,
