...
# body param
SchemaForRequestBody = ContainerForm


request_body_container_form = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _save_new1_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_container_form.serialize(body, content_type)
