...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["user", "password", "endPoint", "type", "callback", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["user", "password", "endPoint", "type", "callback", ], str]):
...
class DeleteEndpoint(BaseApi):
    ...
    def delete_endpoint(
        ...
        return self._delete_endpoint_oapg(
            body=body,
