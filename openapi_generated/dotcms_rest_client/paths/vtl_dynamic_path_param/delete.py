...
class BaseApi(api_client.Api):
    ...
    def _dynamic_delete_oapg(
        self,
        content_type: str = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, str, SchemaForRequestBodyTextPlain, str, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
...
class DynamicDelete(BaseApi):
    ...
    def dynamic_delete(
        ...
        return self._dynamic_delete_oapg(
            body=body,
