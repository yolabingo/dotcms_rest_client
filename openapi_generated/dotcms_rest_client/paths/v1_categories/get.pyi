...
ShowChildrenCountSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'showChildrenCount': typing.Union[ShowChildrenCountSchema, bool, ],
    },
    total=False
)
...
request_query_show_children_count = api_client.QueryParameter(
    name="showChildrenCount",
    style=api_client.ParameterStyle.FORM,
    schema=ShowChildrenCountSchema,
    explode=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _get_categories_oapg(
        ...
        for parameter in (
            ...
            request_query_show_children_count,
        ):
