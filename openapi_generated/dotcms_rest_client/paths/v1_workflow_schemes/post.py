...
# body param
SchemaForRequestBody = WorkflowSchemeForm


request_body_workflow_scheme_form = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _save_scheme_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_workflow_scheme_form.serialize(body, content_type)
