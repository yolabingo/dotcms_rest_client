...
request_path_sortby = api_client.PathParameter(
    name="sortby",
    style=api_client.ParameterStyle.SIMPLE,
    schema=SortbySchema,
    required=True,
)
request_path_limit = api_client.PathParameter(
    name="limit",
    style=api_client.ParameterStyle.SIMPLE,
    schema=LimitSchema,
    required=True,
)
request_path_offset = api_client.PathParameter(
    name="offset",
    style=api_client.ParameterStyle.SIMPLE,
    schema=OffsetSchema,
    required=True,
...
request_path_param_callback = api_client.PathParameter(
    name="callback",
    style=api_client.ParameterStyle.SIMPLE,
...
class IndexSearch(BaseApi):
    ...
    def index_search(
        ...
        return self._index_search_oapg(
