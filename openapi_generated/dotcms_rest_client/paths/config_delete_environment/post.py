...
class SchemaForRequestBodyApplicationXWwwFormUrlencoded(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["user", "password", "environment", "type", "callback", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["user", "password", "environment", "type", "callback", ], str]):
...
class DeleteEnvironment(BaseApi):
    ...
    def delete_environment(
        ...
        return self._delete_environment_oapg(
            body=body,
