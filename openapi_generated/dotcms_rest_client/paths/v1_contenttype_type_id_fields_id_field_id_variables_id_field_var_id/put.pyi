...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_field_variable_by_field_id_oapg(
        self,
...
class UpdateFieldVariableByFieldId(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_field_variable_by_field_id(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, str, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_field_variable_by_field_id(
        ...
        return self._update_field_variable_by_field_id_oapg(
            body=body,
