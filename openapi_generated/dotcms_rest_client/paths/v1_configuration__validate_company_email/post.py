...
# body param
SchemaForRequestBody = CompanyEmailForm


request_body_company_email_form = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _validate_email_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_company_email_form.serialize(body, content_type)
...
class ValidateEmail(BaseApi):
    ...
    def validate_email(
        ...
        return self._validate_email_oapg(
            body=body,
