...
ConditionGroupIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'siteId': typing.Union[SiteIdSchema, str, ],
        'ruleId': typing.Union[RuleIdSchema, str, ],
        'conditionGroupId': typing.Union[ConditionGroupIdSchema, str, ],
    }
)
...
request_path_condition_group_id = api_client.PathParameter(
    name="conditionGroupId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ConditionGroupIdSchema,
    required=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _remove2_oapg(
        ...
        for parameter in (
            ...
            request_path_condition_group_id,
        ):
