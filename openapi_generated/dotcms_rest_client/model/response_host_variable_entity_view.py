...
class ResponseHostVariableEntityView(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def entity() -> typing.Type['HostVariable']:
                return HostVariable
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["entity"]) -> 'HostVariable': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["entity"]) -> typing.Union['HostVariable', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        entity: typing.Union['HostVariable', schemas.Unset] = schemas.unset,
