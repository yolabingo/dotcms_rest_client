...
class BulkActionForm(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["contentletIds", "query", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["contentletIds", "query", ], str]):
