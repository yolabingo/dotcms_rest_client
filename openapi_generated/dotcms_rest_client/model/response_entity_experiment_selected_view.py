...
class ResponseEntityExperimentSelectedView(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def entity() -> typing.Type['SelectedExperiments']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["entity"]) -> 'SelectedExperiments': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["entity"]) -> typing.Union['SelectedExperiments', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        entity: typing.Union['SelectedExperiments', schemas.Unset] = schemas.unset,
