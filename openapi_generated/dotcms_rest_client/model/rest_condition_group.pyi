...
class RestConditionGroup(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["operator", "priority", "conditions", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["operator", "priority", "conditions", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        conditions: typing.Union[MetaOapg.properties.conditions, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
