...
class TemplateLayoutRow(
        ...
        class properties:
            ...
            class columns(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TemplateLayoutColumn']:
                        return TemplateLayoutColumn
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['TemplateLayoutColumn'], typing.List['TemplateLayoutColumn']],
                ...
                def __getitem__(self, i: int) -> 'TemplateLayoutColumn':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["columns", "styleClass", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["columns", "styleClass", ], str]):
