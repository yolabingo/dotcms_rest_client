...
class TemplateLayoutRowView(
        ...
        class properties:
            ...
            class columns(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TemplateLayoutColumnView']:
                        return TemplateLayoutColumnView
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['TemplateLayoutColumnView'], typing.List['TemplateLayoutColumnView']],
                ...
                def __getitem__(self, i: int) -> 'TemplateLayoutColumnView':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["styleClass", "columns", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["styleClass", "columns", ], str]):
