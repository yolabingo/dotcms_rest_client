        ...
        class properties:
            ...
            class entity(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['SiteVariableView']:
                        return SiteVariableView
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['SiteVariableView'], typing.List['SiteVariableView']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'entity':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'SiteVariableView':
                    return super().__getitem__(i)
