...
class ResponseEntityPermissionView(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class entity(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['PermissionView']:
                        return PermissionView
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['PermissionView'], typing.List['PermissionView']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'entity':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'PermissionView':
                    return super().__getitem__(i)
